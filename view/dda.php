...
<?php
  ...
  if(isset($_SESSION['usuario'])){
    //validamos que el usuario que esta logueado sea específicamente DDA
      ...
      <div class="card bg-light mb-3">
        ...
        <div class="card-body">
          <!-- <div class="row">
              ...
              <div class="col-sm-2">
                <a class="btn btn-danger" href="<?=SERVIDOR?>control/control_dda_genera_pdf.php">Generar PDF</a>
              </div>
            </div> -->
          <div class="row mt-1 mb-2">
            ...
            <div class="col-md-2">
              <a href="php/excel.php" target="_BLANK" class="btn border border-dark btn-light mr-2" type="button">Excel</a>
              <a href="php/pdf.php" target="_BLANK" class="btn border border-dark btn-light mr-2">PDF</a>
            </div>
            <div class="col-md-12">
              <hr>
            </div>
...
<!-- <div class="container">
  <div class="row">
    <div class="col">
      <table id="tabla_de_datos" class="display" style="width:100%">
        <thead>
          <tr>
            <th>Name</th>
            <th>Position</th>
  ...
  -->
<script src="manager/manager_dda.js"></script>
